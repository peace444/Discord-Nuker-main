...
- This script is educational and fully coded by M. logique aka @7rb in discord
...
-----   __________/\\\/_______________/\\/\\\\\\\____________\/\\\________     
-----    ________/\\\/________________\/\\\/////\\\___________\/\\\\\\\\\__    
-----    ______/\\\/__________________\/\\\___\///____________\/\\\////\\\_   
-----      ____/\\\/____________________\/\\\___________________\/\\\__\/\\\_  
-----       __/\\\/______________________\/\\\___________________\/\\\\\\\\\__ 
-----        _\///________________________\///____________________\/////////___
...
by ⤥                                                                                                                                                                              
     ...
     |_____ $$/      | $$__  $$      | $$__  $$      | $$$ | $$| $$  | $$| $$  /$$/| $$_____/| $$__  $$
       ...
       /$$/          | $$  \ $$      | $$  \ $$      | $$\  $$$| $$  | $$| $$\  $$ | $$      | $$  \ $$
      /$$/           | $$  | $$      | $$$$$$$/      | $$ \  $$|  $$$$$$/| $$ \  $$| $$$$$$$$| $$  | $$
     |__/            |__/  |__/      |_______/       |__/  \__/ \______/ |__/  \__/|________/|__/  |__/                                                                                                                                                                                              
>                             
>                             
     ...
     :   06. Create Roles         :  13. UnNick All users     :  20. 7 𝖱 𝖡 soon           :
     :   07. Unban All Members    :  14. Change Guild Name    :  21. 7 𝖱 𝖡 soon           :
      (____)(____)(____)(____)(____)(____)(____)(____)(____)(____)(____)(____)(____)(____)
...
def start(args):
    ...
    System.Clear()
    System.Title("Discord Nuker https://discord.gg/3az- ")
    System.Size(160, 40)
